...
const htmlParser = (source) => {
  if (!parser) {
    parser = typeof DOMParser === "function" ? new DOMParser() : new new JSDOM().window.DOMParser();
  }
...
function DOMParserReact(props) {
  const Fragment$1 = props.Fragment || Fragment;
  const element = useMemo(() => parse(props.source, {
    createElement: props.createElement || createElement,
    Fragment: Fragment$1,
    components: props.components
  }), props.deps || [props.source]);
  return typeof element === "string" ? /* @__PURE__ */ createElement(Fragment$1, null, element) : element;
}

export { DOMParserReact as default, parse };
