 ...
 * @public
 */
export function createEqualsFilter(fieldId, value) {
    return {
        fieldId,
 ...
 * @public
 */
export function createNumberRangeFilter(fieldId, range) {
 ...
 * @public
 */
export function createDateRangeFilter(fieldId, range) {
    return createRangeFilter(fieldId, range);
}
 ...
 * @public
 */
export function createNearMeFilter(position) {
    return {
 ...
 * @public
 */
export function combineFilters(filterA, filterB, combinator) {
    return {
        combinator,
