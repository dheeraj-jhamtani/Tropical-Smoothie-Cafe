import { provideHeadless } from '.';
import SearchHeadless from './search-headless';
export { AnswersConfig, AnswersConfigWithToken, AnswersConfigWithApiKey, AnswersCore, AnswersError, AnswersRequest, BaseAnswersConfig } from '@yext/search-core';
/**
 * @public
 *
 ...
 */
export declare const provideAnswersHeadless: typeof provideHeadless;
/**
 * @public
 *
