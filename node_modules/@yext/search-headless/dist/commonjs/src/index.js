...
exports.SearchHeadless = exports.provideHeadless = exports.searchUtilities = void 0;
...
const search_headless_1 = __importDefault(require("./search-headless"));
exports.SearchHeadless = search_headless_1.default;
...
exports.searchUtilities = searchUtilities;
const client_sdk_utils_1 = require("./utils/client-sdk-utils");
__exportStar(require("./search-core-re-exports"), exports);
...
function provideHeadless(config, additionalHttpHeaders) {
    ...
    const answersCore = (0, search_core_1.provideCore)(searchConfig);
    ...
    const httpHeaders = (0, client_sdk_utils_1.getHttpHeaders)(additionalHttpHeaders);
    const headless = new search_headless_1.default(answersCore, stateManager, httpManager, httpHeaders);
    verticalKey
...
exports.provideHeadless = provideHeadless;
/**
