...
function provideAnswersHeadless(config, additionalHttpHeaders) {
    ...
    const headless = new answers_headless_1.default(answersCore, stateManager, httpManager, httpHeaders);
    verticalKey
