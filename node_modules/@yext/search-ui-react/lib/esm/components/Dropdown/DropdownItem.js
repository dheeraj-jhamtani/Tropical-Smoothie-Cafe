...
export function DropdownItemWithIndex(props) {
    ...
    return (_jsx("div", Object.assign({ id: screenReaderUUID && generateDropdownId(screenReaderUUID, index), tabIndex: 0, className: isFocused ? focusedClassName : className, onClick: handleClick, "aria-label": typeof ariaLabel === 'function' ? ariaLabel(value) : ariaLabel }, { children: children }), void 0));
}
