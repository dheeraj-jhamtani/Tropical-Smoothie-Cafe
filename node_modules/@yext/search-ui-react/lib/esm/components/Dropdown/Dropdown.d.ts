...
export interface DropdownProps {
    ...
    onToggle?: (isActive: boolean, prevValue: string, value: string, index: number, focusedItemData: Record<string, unknown> | undefined) => void;
    className?: string;
 ...
 */
export declare function Dropdown(props: PropsWithChildren<DropdownProps>): JSX.Element;
