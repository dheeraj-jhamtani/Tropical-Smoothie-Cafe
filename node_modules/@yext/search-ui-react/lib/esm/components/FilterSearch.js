 ...
 */
export function FilterSearch({ searchFields, label, placeholder = 'Search here...', searchOnSelect = false, sectioned = false, customCssClasses }) {
    ...
    useEffect(() => {
        if (currentFilter && (filters === null || filters === void 0 ? void 0 : filters.find(f => isDuplicateFilter(f, currentFilter) && !f.selected))) {
