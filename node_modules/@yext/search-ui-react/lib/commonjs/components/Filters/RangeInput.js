...
const InvalidIcon_1 = require("../../icons/InvalidIcon");
...
function RangeInput(props) {
    ...
    const { filters } = (0, FiltersContext_1.useFiltersContext)();
    const { fieldId, setIsOptionsDisabled } = (0, FilterGroupContext_1.useFilterGroupContext)();
    ...
    const [minRangeInput, setMinRangeInput] = (0, react_1.useState)('');
    const [maxRangeInput, setMaxRangeInput] = (0, react_1.useState)('');
    ...
    const rangeFilter = (0, react_1.useMemo)(() => {
        return {
            fieldId,
            matcher: search_headless_react_1.Matcher.Between,
            value: (0, filterutils_1.parseNumberRangeInput)(minRangeInput, maxRangeInput),
        };
    ...
    const matchingFilter = (0, filterutils_1.findSelectableFilter)(rangeFilter, staticFilters !== null && staticFilters !== void 0 ? staticFilters : []);
    ...
    const handleMinChange = (0, react_1.useCallback)(event => {
        var _a;
    ...
    const handleMaxChange = (0, react_1.useCallback)(event => {
        var _a;
        const input = (_a = event === null || event === void 0 ? void 0 : event.target) === null || _a === void 0 ? void 0 : _a.value;
        validateNumericInput(input) && setMaxRangeInput(input);
    }, []);
    const handleClickApply = (0, react_1.useCallback)(() => {
        ...
        (0, filterutils_1.clearStaticRangeFilters)(searchActions, new Set([fieldId]));
        searchActions.setFilterOption(Object.assign(Object.assign({}, rangeFilter), { selected: true, displayName }));
        searchActions.setOffset(0);
        (0, search_operations_1.executeSearch)(searchActions);
    }, [searchActions, fieldId, getFilterDisplayName, isValid, rangeFilter]);
    const handleClickClear = (0, react_1.useCallback)(() => {
        const displayName = getFilterDisplayName(rangeFilter.value);
        searchActions.setFilterOption(Object.assign(Object.assign({}, rangeFilter), { selected: false, displayName }));
        setMinRangeInput('');
        setMaxRangeInput('');
        searchActions.setOffset(0);
        (0, search_operations_1.executeSearch)(searchActions);
    ...
    const inputPrefixClasses = (0, classnames_1.default)(cssClasses.inputPrefix, {
    ...
    function renderInput(value, onChange, placeholder) {
        return ((0, jsx_runtime_1.jsxs)("div", Object.assign({ className: cssClasses.inputContainer }, { children: [inputPrefix && (0, jsx_runtime_1.jsx)("span", Object.assign({ className: inputPrefixClasses, "aria-hidden": "true" }, { children: inputPrefix }), void 0), (0, jsx_runtime_1.jsx)("input", { type: 'text', inputMode: 'decimal', value: value, placeholder: placeholder, disabled: isDisabled, className: inputClasses, onChange: onChange }, void 0)] }), void 0));
    }
    return ((0, jsx_runtime_1.jsxs)("div", Object.assign({ className: cssClasses.rangeInputContainer }, { children: [(0, jsx_runtime_1.jsxs)("div", Object.assign({ className: cssClasses.inputRowContainer }, { children: [renderInput(minRangeInput, handleMinChange, 'Min'), (0, jsx_runtime_1.jsx)("div", Object.assign({ className: 'w-2.5 text-sm text-neutral' }, { children: "-" }), void 0), renderInput(maxRangeInput, handleMaxChange, 'Max'), isDisabled &&
                        (0, jsx_runtime_1.jsx)("div", Object.assign({ className: cssClasses.tooltipContainer }, { children: (0, jsx_runtime_1.jsx)("div", Object.assign({ className: cssClasses.tooltip }, { children: "Unselect an option to enter in a range." }), void 0) }), void 0)] }), void 0), !isValid &&
                (0, jsx_runtime_1.jsxs)("div", Object.assign({ className: cssClasses.invalidRowContainer }, { children: [(0, jsx_runtime_1.jsx)(InvalidIcon_1.InvalidIcon, {}, void 0), (0, jsx_runtime_1.jsx)("div", Object.assign({ className: cssClasses.invalidMessage }, { children: "Invalid range" }), void 0)] }), void 0), hasUserInput &&
                (0, jsx_runtime_1.jsxs)("div", Object.assign({ className: cssClasses.buttonsContainer }, { children: [(0, jsx_runtime_1.jsx)("button", Object.assign({ className: cssClasses.clearButton, onClick: handleClickClear }, { children: "Clear min and max" }), void 0), shouldRenderApplyButton &&
                            (0, jsx_runtime_1.jsx)("button", Object.assign({ className: cssClasses.applyButton, onClick: handleClickApply }, { children: "Apply" }), void 0)] }), void 0)] }), void 0));
}
