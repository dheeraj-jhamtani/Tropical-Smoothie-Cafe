...
function DropdownInput(props) {
    ...
    const { focusedIndex = -1, focusedItemData, updateFocusedItem } = (0, FocusContext_1.useFocusContext)();
    ...
    return ((0, jsx_runtime_1.jsx)("input", { ref: inputRef, className: className, placeholder: placeholder, value: value, onChange: handleChange, onKeyDown: handleKeyDown, onFocus: handleFocus, id: screenReaderUUID && (0, generateDropdownId_1.generateDropdownId)(screenReaderUUID, -1), autoComplete: 'off', "aria-describedby": screenReaderUUID, "aria-activedescendant": screenReaderUUID && (0, generateDropdownId_1.generateDropdownId)(screenReaderUUID, focusedIndex), "aria-label": ariaLabel }, void 0));
}
