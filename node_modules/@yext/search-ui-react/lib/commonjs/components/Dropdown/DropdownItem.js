...
function DropdownItemWithIndex(props) {
    ...
    return ((0, jsx_runtime_1.jsx)("div", Object.assign({ id: screenReaderUUID && (0, generateDropdownId_1.generateDropdownId)(screenReaderUUID, index), tabIndex: 0, className: isFocused ? focusedClassName : className, onClick: handleClick, "aria-label": typeof ariaLabel === 'function' ? ariaLabel(value) : ariaLabel }, { children: children }), void 0));
}
