 ...
 */
function FilterSearch({ searchFields, label, placeholder = 'Search here...', searchOnSelect = false, sectioned = false, customCssClasses }) {
    ...
    const filters = (0, search_headless_react_1.useSearchState)(state => state.filters.static);
    ...
    (0, react_1.useEffect)(() => {
        if (currentFilter && (filters === null || filters === void 0 ? void 0 : filters.find(f => (0, filterutils_1.isDuplicateFilter)(f, currentFilter) && !f.selected))) {
    ...
    const handleDropdownEvent = (0, react_1.useCallback)((value, itemData, select) => {
        ...
        if (newFilter && newDisplayName) {
            if (currentFilter) {
                searchActions.setFilterOption(Object.assign(Object.assign({}, currentFilter), { selected: false }));
            }
            searchActions.setFilterOption(Object.assign(Object.assign({}, newFilter), { displayName: newDisplayName, selected: true }));
