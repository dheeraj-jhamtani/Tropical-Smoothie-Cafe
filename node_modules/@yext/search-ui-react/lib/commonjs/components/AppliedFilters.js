...
function AppliedFilters(props) {
    ...
    const { hiddenFields = DEFUALT_HIDDEN_FIELDS, customCssClasses = {}, hierarchicalFacetsDelimiter = HierarchicalFacetDisplay_1.DEFAULT_HIERARCHICAL_DELIMITER, hierarchicalFacetsFieldIds } = props;
