...
exports.getSelectedNumericalFacetFields = exports.clearStaticRangeFilters = exports.parseNumberRangeInput = exports.findSelectableFilter = exports.isDuplicateFilter = exports.isNumericalFacet = exports.isNumberRangeValue = exports.isNearFilterValue = void 0;
...
function isNumericalFacet(facet) {
    return facet.options.length > 0 && (0, NumberRangeFilter_1.isNumberRangeFilter)(facet.options[0]);
}
exports.isNumericalFacet = isNumericalFacet;
/**
 * Returns true if the two given filters are the same.
 */
function isDuplicateFilter(thisFilter, otherFilter) {
    ...
    if (!(0, isEqual_1.default)(thisFilter.value, otherFilter.value)) {
        return false;
    }
    return true;
}
exports.isDuplicateFilter = isDuplicateFilter;
/**
 ...
 */
function findSelectableFilter(filter, selectableFilters) {
...
exports.findSelectableFilter = findSelectableFilter;
/**
