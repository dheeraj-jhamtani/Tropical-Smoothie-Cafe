...
var composeTheme = function composeTheme(options) {
  ...
  var composeMethod = typeof first.compose === 'string' ? first.compose : exports.Compose.Merge;
  var resultTheme;
  var dependencies;
  ...
  var _loop = function _loop(i) {
    ...
    if (checkCache && composeMethod !== exports.Compose.Replace) {
    ...
    if (composeMethod === exports.Compose.Replace) {
    ...
    if (composeMethod === exports.Compose.Merge) {
    ...
    } else if (composeMethod === exports.Compose.Assign) {
...
exports.filterThemeWithPrefix = filterThemeWithPrefix;
exports.getCachedPrefixedTheme = getCachedPrefixedTheme;
exports.getCachedThemeCompositionDependencies = getCachedThemeCompositionDependencies;
exports.getThemeCompositionDependencies = getThemeCompositionDependencies;
