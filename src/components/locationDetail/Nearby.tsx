  ...
  return (
    ...
    <>
      ...
      <div className="container">
        <div className="sec-title"><h2 className="">{props.c_nearbyStoresHeading?props.c_nearbyStoresHeading:StaticData.NearStoretext}</h2></div>
        ...
        {neabyData.map((location: any, index: Number) => {
          ...
          {props.c_seeMore?
          <a href={props.c_seeMore.link}>{props.c_seeMore.label}</a>
          :''}
      </div>
      :''}
      {/* </Splide> */}
